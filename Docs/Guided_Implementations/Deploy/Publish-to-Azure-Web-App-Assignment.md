...
- An **Azure Web App for Linux** already created for Task Master (e.g. **taskMaster-<your_initials>**).
...
3. In the **Azure** sidebar, expand **App Services** and find your Web App (**taskMaster-<your_initials>**). (If you don’t see it, check the correct subscription at the top of the Azure view.)

4. Right‑click **taskMaster-<your_initials>** and choose **Deploy to Web App...** (or **Deploy to Web App**).
...
6. When deployment succeeds, open your site at **https://taskMaster-<your_initials>.azurewebsites.net** (or use **Browse Website** from the right‑click menu on the app in the sidebar).

---

## 5. Verify the Deployed Site

1. Open a browser and go to **https://taskMaster-<your_initials>.azurewebsites.net** (or use **Browse Website** from the Azure sidebar).
